        ...
        <div class="about-container">
            ...
            <section class="about-section">
                ...
                <div class="contact-info">
                    <p><i class="fas fa-map-marker-alt"></i> <strong>Address:</strong> machava kigamboni, DC 10001</p>
                    <p><i class="fas fa-phone"></i> <strong>Phone:</strong> +255 749247378</p>
                    <p><i class="fas fa-envelope"></i> <strong>Email:</strong>francoder@gmail.com</p>
